            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 max-w-[540px] lg:mb-0">
                ...
                <p className="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6">
                  ...
                  passionate about creating websites that help businesses
                  thrive in the digital world.
                  <br /> <br />
                  From concept to launch, we work closely with our clients to
                  deliver tailored solutions that drive engagement, increase
                  conversions, and build lasting online presence.
                </p>
